...
{
    private readonly IGoodsReceiptDetailService _goodsReceiptDetailServices;
    private readonly IRepository<GoodsReceiptDetail> _goodsReceiptDetail;

    public GoodsReceiptDetailController(IGoodsReceiptDetailService goodsReceiptDetailServices, IRepository<GoodsReceiptDetail> goodsReceiptDetail)
    {
